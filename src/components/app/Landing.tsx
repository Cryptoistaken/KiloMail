...
import { KiloMailLogo } from "./KiloMailLogo"
  ...
  return (
    <TooltipProvider>
      <div className="relative flex min-h-screen flex-col overflow-hidden bg-background">
        ...
        {/* ── Persistent flickering background ── */}
        <FlickeringBg />
        ...
        {/* ── Globe (bottom, partially clipped) ── */}
        ...
        <div className="relative z-[4] flex flex-1 flex-col">
          ...
          <nav className="flex items-center justify-between px-6 pt-5">
            <div className="flex items-center gap-2">
              <KiloMailLogo variant="icon" className="h-7 w-7 sm:hidden" />
              <KiloMailLogo variant="logo" className="hidden h-5 sm:block" />
            </div>
